...
async function main() {
  ...
  console.log("npx hardhat verify --network " + network.name + " " + instance.address + " " + metadataAddress + " " + mintingFeeReceiver + " " + directoryAddress + " " + statsMiddlewareAddress + " " + sfsAddress + ' "' + sfsNftTokenId + '" "' + mintingFeePercentage + '" "' + price + '"');
}
